...
function Note() {
    ...
    return (
        <div className="hidden sm:block fixed bottom-2 right-2 z-20">
            ...
            <div
                onClick={handleClick}
                className="transition-transform duration-300 ease-in-out w-28 h-28 flex items-center justify-center cursor-pointer rounded-lg"
            >
            ...
            <AnimatePresence>
                {isExpanded && (
                    <motion.div
                        ...
                        className="absolute bottom-14 right-4 mb-2 p-3 shadow-lg w-44 bg-[#000]/[.5] rounded"
